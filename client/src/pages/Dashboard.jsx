...
const Dashboard = () => {
  ...
  const [showUploadResume, setShowUploadResume] = useState([])
  ...
  return (
    <div>
        <div className='max-w-7xl mx-auto px-4 py-8'>
          <p className='text-2xl font-medium mb-6 bg-gradient-to-r 
              ...
              {allResumes.map((resume, index)=>{
                ...
                return(
                  ...
                  style={{
                    ...
                    <p className='text-sm group-hover:scale-105 transtion-all px-2
                    ...
                    text-center' style={{color:baseColor +'90'}}> Updated on 
