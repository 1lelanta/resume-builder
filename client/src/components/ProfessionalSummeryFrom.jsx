  ...
  return (
    <div className='space-y-4'>
        <div className='flex items-center justify-between'>
          ...
          texr-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opcity-30'>
        ...
        <div className='tm-6'>
          ...
          <p className='rext-xs text-gray-500 max-w-4/5 mx-auto text-center'>
...
export default ProfessionalSummeryFrom